...
const BotButton = styled(IconButton)({
  ...
  backgroundColor: '#1976d2',
  color: 'white',
  zIndex: 1301, // Higher than container to stay on top when closed
...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    { 
      text: "Hello there! I'm Testy your TestTrust assistant. I can help you with creating exams, managing questions, and more. How can I assist you today?", 
      sender: 'bot',
      timestamp: new Date(),
      isLoading: false
    }
    ...
    const knowledgeBase = [
      // Greetings
      {
        ...
        responses: [
          ...
          'Greetings!, I\'m Testy, How can I help you with our testing platform today?'
        ]
      },
      {
      ...
      // Exam Management
      {
        ...
        responses: [
          'To create a new exam: 1) Go to Dashboard 2) Click "Add Exam" 3) Fill in exam details 4) Add questions 5) Set time limits 6) Publish when ready.',
          'Creating an exam is simple! Navigate to Dashboard → Add Exam. You can set the exam name, duration, passing score, and add various question types.'
        ]
      },
      {
        patterns: ['edit exam', 'modify exam', 'update exam', 'how to edit exam', 'how to modify exam', 'how to update exam'],
        responses: [
          'To edit an exam: 1) Go to "Manage Exams" 2) Find your exam 3) Click the edit icon 4) Make your changes 5) Save updates.',
          'You can modify any exam by going to Manage Exams, selecting your exam, and clicking the edit button. Remember, some changes might not be possible after students have started taking the exam.'
        ]
      },
      {
        patterns: ['delete exam', 'remove exam', 'how to delete exam', 'how to remove exam'],
        responses: [
          'To delete an exam: 1) Go to "Manage Exams" 2) Find the exam 3) Click the delete icon 4) Confirm deletion. Note: This action cannot be undone.',
          'You can remove exams from the Manage Exams section. Just click the delete icon next to the exam you want to remove. Be careful, as this will delete all related data.'
        ]
      },
      
      // Question Management
      {
        patterns: ['add question', 'new question', 'create question', 'how to add questions'],
        responses: [
          'To add questions: 1) Go to "Manage Exams" 2) Select your exam 3) Click "Add Question" 4) Choose question type 5) Enter question details 6) Save.',
          'You can add multiple question types: multiple choice, true/false, short answer, and more. Just go to Manage Exams, select your exam, and click "Add Question".'
        ]
      },
      {
        patterns: ['question types', 'kinds of questions', 'what questions can i add'],
        responses: [
      ...
      {
        patterns: ['import questions', 'upload questions', 'bulk add questions'],
        responses: [
          'To import questions: 1) Go to "Manage Exams" 2) Select your exam 3) Click "Import Questions" 4) Choose your file (CSV/Excel) 5) Map the columns 6) Import.',
          'You can bulk upload questions using a CSV or Excel file. Make sure to follow the template format available in the import section.'
        ]
      },
